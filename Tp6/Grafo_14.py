...
mi_grafo.insert_arist('cocina', 'cochera', 9)
mi_grafo.insert_arist('cocina', 'comedor', 6)
mi_grafo.insert_arist('cocina', 'quincho', 2)
mi_grafo.insert_arist('baño 1', 'comedor', 12)
mi_grafo.insert_arist('baño 1', 'cochera', 4)
mi_grafo.insert_arist('baño 1', 'quincho', 7)
mi_grafo.insert_arist('baño 2', 'comedor', 4)
mi_grafo.insert_arist('baño 2', 'cochera', 5)
mi_grafo.insert_arist('baño 2', 'quincho', 8)
mi_grafo.insert_arist('habitación 1', 'terraza', 3)
mi_grafo.insert_arist('habitación 1', 'patio', 4)
mi_grafo.insert_arist('habitación 1', 'comedor', 15)
mi_grafo.insert_arist('habitación 2', 'terraza', 4)
mi_grafo.insert_arist('habitación 2', 'patio', 3)
mi_grafo.insert_arist('habitación 2', 'comedor', 10)
mi_grafo.insert_arist('sala de estar', 'terraza', 6)
mi_grafo.insert_arist('sala de estar', 'patio', 5)
mi_grafo.insert_arist('sala de estar', 'comedor', 7)
mi_grafo.insert_arist('sala de estar', 'baño 1', 5)
mi_grafo.insert_arist('sala de estar', 'baño 2', 4)



minimo = mi_grafo.kruskal()
print(minimo)
total = 0
for i in minimo:
    k=i.split(";")
    for j in k:
        total = total + int(j.split("-")[2])
print()
print(f"Se necesitan {total} metros de cable")
...
print(f"Se necesitan {value[1]} metros para conectar el router la tv")